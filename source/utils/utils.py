...
def get_slide(slide_id: str) -> OpenSlide:
    slide_file_path = find_slide_file_path(slide_id)
...
def find_slide_file_path(slide_id: str, slide_dir: str) -> str:
...
def find_coordinates_file_path(slide_id: str, patch_coordinate_dir: str) -> str:
