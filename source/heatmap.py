...
class HeatmapGenerator:
    ...
    def generate_heatmap(self, slide, heatmap_vector, coordinates):
    ...
    def get_patch_size_for_plotting(self, slide):
        scaling_factor = (
